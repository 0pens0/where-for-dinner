...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","dynamicMsgBroker":true,"dbType":"h2","enableCloudEvents":false,"devDefaultAccountPassword":"letseat","empty":"","enableSecurity":true,"gatewayType":"ossscg","appSSOName":"appsso-where-for-dinner","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"secureProfile":"secure","artifactId":"where-for-dinner","serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"apps","cacheType":"inmemCache","ployglotWorkloads":true}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input11883124109032541556, --data-values-file, /tmp/accelerator-options9445090519868819416.json, --output-files, /tmp/ytt-output15660948152367949309]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","dynamicMsgBroker":true,"dbType":"h2","enableCloudEvents":false,"devDefaultAccountPassword":"letseat","empty":"","enableSecurity":true,"gatewayType":"ossscg","appSSOName":"appsso-where-for-dinner","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"secureProfile":"secure","artifactId":"where-for-dinner","serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"apps","cacheType":"inmemCache","ployglotWorkloads":true}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input15704067996680210889, --data-values-file, /tmp/accelerator-options2626413987700457241.json, --output-files, /tmp/ytt-output11434856374533876288]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug doc/images/KnativeEventing.png didn't match [**/appSSOInstance.yaml, **/workloadRegistrationResourceClaim.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug templates/knEventing.yaml didn't match [**/appSSOInstance.yaml, **/workloadRegistrationResourceClaim.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","dynamicMsgBrokerClass":"msgbroker-crossplane-where-for-dinner","artifactVersion":"0.0.1-beta","dynamicMsgBroker":true,"dbType":"h2","enableCloudEvents":false,"devDefaultAccountPassword":"letseat","empty":"","enableSecurity":true,"gatewayType":"ossscg","appSSOName":"appsso-where-for-dinner","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"secureProfile":"secure","artifactId":"where-for-dinner","serviceNamespace":"service-instances","msgBrokerType":"rabbitmq","projectName":"where-for-dinner","workloadNamespace":"apps","cacheType":"inmemCache","ployglotWorkloads":true}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input5350364803429672681, --data-values-file, /tmp/accelerator-options11265412310949601124.json, --output-files, /tmp/ytt-output7442541461120350875]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug doc/images/KnativeEventing.png didn't match [where-for-dinner-ui/.env] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug templates/knEventing.yaml didn't match [where-for-dinner-ui/.env] -> excluded
